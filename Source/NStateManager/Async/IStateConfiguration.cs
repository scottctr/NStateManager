...
namespace NStateManager.Async
{
    public interface IStateConfiguration<T, TState, TTrigger>
    {
        ...
        /// <returns></returns>
        IStateConfiguration<T, TState, TTrigger> AddAutoDynamicTransition(TTrigger trigger, Func<T, TState> function, string name = null, uint priority = 1);
        ...
        /// <param name="priority">Priority of this transition compared with the other transitions for this state.</param>
        /// <returns></returns>
        IStateConfiguration<T, TState, TTrigger> AddAutoDynamicTransition<TRequest>(TTrigger trigger, Func<T, TRequest, TState> function, string name = null, uint priority = 1)
        ...
        /// <param name="priority">Priority of this transition compared with the other transitions for this state.</param>
        /// <returns></returns>
        IStateConfiguration<T, TState, TTrigger> AddAutoFallbackTransition(TTrigger trigger, TState tempState, Func<T, CancellationToken, Task<bool>> condition, string name = null, uint priority = 1);
        ...
        /// <param name="priority">Priority of this transition compared with the other transitions for this state.</param>
        /// <returns></returns>
        IStateConfiguration<T, TState, TTrigger> AddAutoFallbackTransition<TRequest>(TTrigger trigger, TState tempState, Func<T, TRequest, CancellationToken, Task<bool>> condition, string name = null, uint priority = 1)
            where TRequest : class;
        ...
        /// <param name="priority">Priority of this transition compared with the other transitions for this state.</param>
        /// <returns></returns>
        IStateConfiguration<T, TState, TTrigger> AddAutoForwardTransition<TRequest>(TTrigger trigger, TState toState, Func<T, TRequest, CancellationToken, Task<bool>> condition, string name = null, uint priority = 1)
            where TRequest : class;
        ...
        /// <param name="priority">Priority of this transition compared with the other transitions for this state.</param>
        /// <returns></returns>
        IStateConfiguration<T, TState, TTrigger> AddAutoForwardTransition(TTrigger trigger, TState toState, Func<T, CancellationToken, Task<bool>> condition, string name = null, uint priority = 1);
        ...
        /// <param name="priority">Priority of this transition compared with the other transitions for this state.</param>
        /// <returns></returns>
        IStateConfiguration<T, TState, TTrigger> AddDynamicTransition<TRequest>(TTrigger trigger, Func<T, TRequest, TState> stateFunction, string name = null, uint priority = 1)
            where TRequest : class;
        ...
        /// <returns></returns>
        IStateConfiguration<T, TState, TTrigger> AddEntryAction(Func<T, CancellationToken, Task> action);
        ...
        /// <returns></returns>
        IStateConfiguration<T, TState, TTrigger> AddEntryAction(Func<T, CancellationToken, Task> action, TState previousState);
        ...
        /// <param name="action">The action to execute.</param>
        /// <returns></returns>
        IStateConfiguration<T, TState, TTrigger> AddExitAction(Func<T, CancellationToken, Task> action);
        ...
        /// <returns></returns>
        IStateConfiguration<T, TState, TTrigger> AddExitAction(Func<T, CancellationToken, Task> action, TState nextState);
        ...
        /// <param name="action">The action to execute.</param>
        /// <returns></returns>
        IStateConfiguration<T, TState, TTrigger> AddReentryAction(Func<T, CancellationToken, Task> action);
        ...
        /// <returns></returns>
        IStateConfiguration<T, TState, TTrigger> AddTransition(TTrigger trigger, TState toState, Func<T, CancellationToken, Task<bool>> conditionAsync = null, string name = null, uint priority = 1);
        ...
        /// <param name="priority">Priority of this transition compared with the other transitions for this state.</param>
        /// <returns></returns>
        IStateConfiguration<T, TState, TTrigger> AddTransition<TRequest>(TTrigger trigger, TState toState, Func<T, TRequest, CancellationToken, Task<bool>> conditionAsync, string name = null, uint priority = 1)
            where TRequest : class;
        ...
        /// <param name="action">The action to execute.</param>
        /// <returns></returns>
        IStateConfiguration<T, TState, TTrigger> AddTriggerAction(TTrigger trigger, Func<T, CancellationToken, Task> action);
        ...
        /// <param name="action">The action to execute.</param>
        /// <returns></returns>
        IStateConfiguration<T, TState, TTrigger> AddTriggerAction<TRequest>(TTrigger trigger, Func<T, TRequest, CancellationToken, Task> action);
