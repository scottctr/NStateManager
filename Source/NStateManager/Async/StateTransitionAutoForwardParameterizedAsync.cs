...
{
    internal class StateTransitionAutoForwardParameterizedAsync<T, TState, TTrigger, TParam> : StateTransitionParameterizedAsync<T, TState, TTrigger, TParam>
        where TParam : class
        where TState : IComparable
    {
        ...
        public StateTransitionAutoForwardParameterizedAsync(IStateMachineAsync<T, TState, TTrigger> stateMachine, TState toState, TState triggerState, Func<T, TParam, CancellationToken, Task<bool>> conditionAsync, string name, uint priority)
