...
namespace NStateManager.Async
{
        ...
        where TState : IComparable
    {
        ...
        public StateTransitionAutoForward(IStateMachine<T, TState, TTrigger> stateMachine, TState triggerState, TState toState, Func<T, CancellationToken, Task<bool>> conditionAsync, string name, uint priority)
