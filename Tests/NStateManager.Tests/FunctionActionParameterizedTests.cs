...
namespace NStateManager.Tests
{
    public class FunctionActionParameterizedTests
    {
        ...
        public async Task ExecuteAsync_executes_Action()
        {
            ...
            await sut.ExecuteAsync(sale, request: sale, cancellationToken: default);
        ...
        public async Task ExecuteAsync_throws_ArgumentException_if_request_wrong_Type()
        {
            ...
            await Assert.ThrowsAsync<ArgumentException>(() => sut.ExecuteAsync(sale, request: "wrongType", cancellationToken: default));
        }
    }
}
