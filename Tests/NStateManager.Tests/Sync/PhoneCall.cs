...
namespace TelephoneCallExample
{
    ...
    {
        private readonly StateMachine<PhoneCall, State, Trigger> _stateMachine = new StateMachine<PhoneCall, State, Trigger>(
        ...
        {
            _caller = caller;
            _stateMachine.ConfigureState(State.OffHook)
            ...
            _stateMachine.ConfigureState(State.Ringing)
               .AddTransition(Trigger.CallConnected, State.Connected);

            _stateMachine.ConfigureState(State.Connected)
               .AddEntryAction(_ =>
                { 
            ...
            _stateMachine.ConfigureState(State.OnHold)
               .AddEntryAction(_ =>
                {
        ...
        public void Mute()
        {
            _stateMachine.FireTrigger(this, Trigger.MuteMicrophone);
        }

        public void Unmute()
        {
            _stateMachine.FireTrigger(this, Trigger.UnmuteMicrophone);
        }

        public void SetVolume(int volume)
        {
            //TODO consider not requiring TRequest to be a class
            _stateMachine.FireTrigger(this, Trigger.SetVolume, new Volume(volume));
        }
        ...
        {
            _stateMachine.FireTrigger(this, Trigger.CallDialed, callee);
        }

        public void Connected()
        {
            _stateMachine.FireTrigger(this, Trigger.CallConnected);
        }

        public void Hold()
        {
            _stateMachine.FireTrigger(this, Trigger.PlacedOnHold);
        }

        public void Resume()
        {
            _stateMachine.FireTrigger(this, Trigger.TakenOffHold);
        }

        public ConfigurationSummary<State, Trigger> GetSummary()
        {
            return _stateMachine.GetSummary();
        }
    }
